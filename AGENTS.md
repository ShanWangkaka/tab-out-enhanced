# AGENTS.md -- Tab Out Enhanced: Setup & Onboarding Guide for Coding Agents

You're installing **Tab Out Enhanced** for the user. This is an enhanced version of the original Tab Out by Zara Zhang. Your job is not just to set it up -- it's to get them excited about using it.

## 🙏 Credits

Original project: [Tab Out](https://github.com/zarazhangrui/tab-out) by [Zara](https://x.com/zarazhangrui)
Enhanced by: ShanWangkaka
